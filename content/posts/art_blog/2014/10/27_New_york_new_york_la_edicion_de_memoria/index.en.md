---
title: New York, New York... the “memory” edition
...
- iPhoneography
- street photography
description: I’ve been wanting to share a workflow I’m exploring. Usually I edit photos with a sequential system of several passes.
---
...
The normal cycle is to do a review of all the material immediately after capture and let it sit for a year before doing the second pass (on all the material). From the combination comes the “draft” of my work, which I post on my [photoblog](http://justpictures.es/). At this stage I already nominate some photographs as “[my-favs](https://justpictures.es/archives/tags/myfavs/)”, which are the ones I show when someone asks for a theme. To do something I consider meditated I leave it even longer.
...
It’s curious that this photo was the sixth I remembered. For me this image is the key to what I want to achieve when photographing a city. To avoid going on a long explanation [the explanation is on my blog](../../../2011/03/31_My_Very_Special_Photo_New_York_Essence).
...
Another system I usually use is opening a folder at random and picking [any photo](http://thefoolonthehill.fransimo.info/tag/reencuentros/) to see what comes out. This system is definitely just for fun; the memory one is something I’ll keep working on.
